...
const PersonalView = () => {
  return (
    <div className="dashboard-content" style={{ padding: '2rem', display: 'flex', flexDirection: 'column', alignItems: 'center', justifyContent: 'center', minHeight: '60vh' }}>
      <div style={{ background: 'var(--bg-hover)', padding: '3rem', borderRadius: '24px', border: '1px solid var(--border)', textAlign: 'center', maxWidth: '500px' }}>
        <h1 style={{ fontSize: '3rem', fontWeight: 900, background: 'linear-gradient(45deg, var(--accent), var(--green))', WebkitBackgroundClip: 'text', WebkitTextFillColor: 'transparent', marginBottom: '1rem' }}>Personal Hub</h1>
        <h2 style={{ fontSize: '1.5rem', fontWeight: 700, color: 'var(--text-primary)', marginBottom: '1rem' }}>Coming Soon...</h2>
        <p style={{ color: 'var(--text-secondary)', lineHeight: 1.6 }}>We are redesigning the isolated personal space to give you the most premium experience. Stay tuned!</p>
      </div>
    </div>
  );
};
